...
def test_bike_constructs():
    bike = Bike(1, "Test brand", "Test colour", "fair", "2023-08-25", 1)
    assert bike.id == 1
...
def test_bikes_format_nicely():
    bike = Bike(1, "Test brand", "Test colour", "fair", "2023-08-25", 1)
    assert str(bike) == "Bike(1, Test brand, Test colour, fair, 2023-08-25, 1)"
...
def test_bikes_are_equal():
    bike1 = Bike(1, "Test brand", "Test colour", "fair", "2023-08-25", 1)
    bike2 = Bike(1, "Test brand", "Test colour", "fair", "2023-08-25", 1)
    assert bike1==bike2